...
public record KernelProcessDelegateStepInfo : KernelProcessStepInfo
{
    ...
    public KernelProcessDelegateStepInfo(Type innerStepType, KernelProcessStepState state, Dictionary<string, List<KernelProcessEdge>> edges, Dictionary<string, KernelProcessEdgeGroup>? incomingEdgeGroups = null) : base(innerStepType, state, edges, incomingEdgeGroups)
    {
    }
