...
/// </summary>
public static class CoreProcessFactory
{
    /// <summary>
    ...
    public static async Task<CoreKernelProcessContext> StartAsync(this KernelProcess process, KernelProcessEvent initialEvent, string? processId = null)
    {
        ...
        CoreKernelProcessContext processContext = new(process);
