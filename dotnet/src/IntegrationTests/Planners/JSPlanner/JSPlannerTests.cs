...
namespace SemanticKernel.IntegrationTests.Planners.JSPlanner;

public sealed class JSPlannerTests : IDisposable
{
    private readonly string _bingApiKey;

    public JSPlannerTests(ITestOutputHelper output)
    {
    ...
    public async Task CanExecuteStepwisePlanAsync(string prompt, string partialExpectedAnswer)
    {
        ...
        Assert.Contains(partialExpectedAnswer, planResult, StringComparison.OrdinalIgnoreCase);
